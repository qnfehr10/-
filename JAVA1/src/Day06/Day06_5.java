...
public class Day06_5 {
	...
	public static void main(String[] args) {
		...
		System.out.println(한국인1);
		
			// 2. 필드 1개 생성자 객체 생성
		Korean 한국인2 = new Korean("유재석");
				//한국인2 국적과 이름이 있지만 주민등록번호가 없음
		System.out.println(한국인2);
		
			// 3. 필드 2개 생성자 객체 생성
		Korean 한국인3 = new Korean("강호동", "123456-123456");
				//한국인3 국적, 이름, 주민등록번호가 있음
		System.out.println(한국인3);
		
			// 4. 필드 3개 생성자 객체 생성
		Korean 한국인4 = new Korean("일본", "신동엽", "123456-123456");
				//한국인4 국적이 일본으로 바뀌고 이름, 주민등록번호가 있음
		System.out.println(한국인4);
