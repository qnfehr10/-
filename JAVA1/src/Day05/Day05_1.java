...
public class Day05_1 {
	...
	public static void main(String[] args) {
		...
		// 변수 : 하나의 데이터 저장
				...
				// 2차원 배열 : 가로길이 세로길이
					// 형태 : 자료형[][] 배열명 = new 자료형[가로=행 = y][세로=열 = x]
					// int[][] arr2 = new int[4][3]
					// int int int
					// int int int
					// int int int
					// int int int
					// * int형 변수 12개 저장 할 수 있는 배열
				...
				int[][] 배열2 = new int[2][3]; // [y가로행 2][x세로열3] // 4바이트 * 2 * 3 => 24바이트
				...
				int[][] 배열3 = new int[2][50]; // int:4바이트 *2*50 => 400바이트 배열 선언 => int100 개 저장
				...
				for( int i=0; i<100; i++) {
					...
					if( i<50 ) 배열3[0][i]= i; // i가 50미만이면 첫행
						// [0] : 첫번째 행
						// [i] : i번째 열번호
					else 배열3[1][i-50] = i; //i가 50 이상이면 두번째행
						// [1] : 두번째 행번호
						// [i] : i번째 열번호
				} //for 
